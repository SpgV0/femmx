// beladrawView.h : interface of the CbeladrawView class
//
/////////////////////////////////////////////////////////////////////////////

class CbeladrawView : public CView {
  protected: // create from serialization only
  CbeladrawView();
  DECLARE_DYNCREATE(CbeladrawView)

  // Attributes
  public:
  CbeladrawDoc* GetDocument();
...
#ifndef _DEBUG // debug version in beladrawView.cpp
inline CbeladrawDoc* CbeladrawView::GetDocument()
{
