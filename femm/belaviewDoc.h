// belaviewDoc.h : interface of the CbelaviewDoc class
//
/////////////////////////////////////////////////////////////////////////////
#include "lua.h"
#include "luadebug.h"
...
class CbelaviewDoc : public CDocument {
  protected: // create from serialization only
  CbelaviewDoc();
  DECLARE_DYNCREATE(CbelaviewDoc)
  ...
  CArray<belaviewtype::CNode, belaviewtype::CNode&> nodelist;
  CArray<belaviewtype::CSegment, belaviewtype::CSegment&> linelist;
  CArray<belaviewtype::CBlockLabel, belaviewtype::CBlockLabel&> blocklist;
  CArray<belaviewtype::CArcSegment, belaviewtype::CArcSegment&> arclist;

  // CArrays containing the mesh information
  CArray<belaviewtype::CMeshNode, belaviewtype::CMeshNode&> meshnode;
  CArray<belaviewtype::CElement, belaviewtype::CElement&> meshelem;
  ...
  // lists of properties
  CArray<belaviewtype::CMaterialProp, belaviewtype::CMaterialProp&> blockproplist;
  CArray<belaviewtype::CBoundaryProp, belaviewtype::CBoundaryProp&> lineproplist;
  CArray<belaviewtype::CPointProp, belaviewtype::CPointProp&> nodeproplist;
  CArray<belaviewtype::CCircuit, belaviewtype::CCircuit&> circproplist;
  ...
  BOOL GetPointValues(double x, double y, belaviewtype::CPointVals& u);
  BOOL GetPointValues(double x, double y, int k, belaviewtype::CPointVals& u);
  ...
  double ElmArea(belaviewtype::CElement* elm);
  void GetPointD(double x, double y, CComplex& D, belaviewtype::CElement& elm);
  ...
  void GetCircle(belaviewtype::CArcSegment& asegm, CComplex& c, double& R);
  double ShortestDistanceFromArc(CComplex p, belaviewtype::CArcSegment& arc);
