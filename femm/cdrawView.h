// cdrawView.h : interface of the CcdrawView class
//
/////////////////////////////////////////////////////////////////////////////

class CcdrawView : public CView {
  protected: // create from serialization only
  CcdrawView();
  DECLARE_DYNCREATE(CcdrawView)

  // Attributes
  public:
  CcdrawDoc* GetDocument();
...
#ifndef _DEBUG // debug version in cdrawView.cpp
inline CcdrawDoc* CcdrawView::GetDocument()
{
