...
other physics could otherwise produce nothing but BMP or WMF. Only the
magnetics pair honours {\tt setgui("qt")}, because {\tt femmqt} supports
magnetics only --- the others report that and ask for
{\tt setgui("classic")} rather than quietly rendering with a different
GUI than the one requested.
\end{itemize}
