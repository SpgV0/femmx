...
\item {\tt mi\_setgpuaccel(flag)} and {\tt ei\_setgpuaccel(flag)} ---
opt the magnetics and electrostatics solvers into CUDA-accelerated
solving.
\item {\tt mi\_setredraw(flag)} and {\tt ei\_setredraw(flag)} ---
suppress redraws during a scripted sequence of edits.
